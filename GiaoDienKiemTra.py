...
class BMI_Class:
    def __init__(self,root):
        ...
        title = Label(self.root, text="Tính BMI",font =("Elephant",25),bg="#E0FFFF").pack(side=TOP,fill=X)
        title_bottom = Label(self.root,font =("times new roman",15),bg="gray").pack(side=BOTTOM,fill=X)
...
#          ======= Variable =========
        ...
        lbl_height=Label(self.root,text="Nhập chiều cao",font=("goudy old style",20),bg="#E0FFFF").place(x=50,y=100)
        txt_height=Entry(self.root,textvariable=self.var_height,font=("times new roman",15),bg="white").place(x=250,y=100,width=300,height=40)

        lbl_weight=Label(self.root,text="Nhập cân nặng",font=("goudy old style",15),bg="#E0FFFF").place(x=50,y=170)
        txt_weight=Entry(self.root,textvariable=self.var_weight,font=("times new roman",15),bg="white").place(x=250,y=170,width=300,height=40)

        btn_BMI=Button(self.root,text="Tính BMI",bg="#47d1d1",command=self.BMI,font=("times new roman",15)).place(x=250,y=240,width=130,height=50)

        lbl_your_BMI = Label(self.root, text="BMI của bạn", font=("goudy old style", 15), bg="#E0FFFF").place(x=50, y=320)
        ...
        lbl_state = Label(self.root, text=" Tình trạng của bạn", font=("goudy old style", 15), bg="#E0FFFF").place(x=50, y=400)
        ...
        lbl_weight = Label(self.root, text="Nguy cơ phát triển của bệnh", font=("goudy old style", 15), bg="#E0FFFF").place(x=50, y=480)
        ...
        btn_exit=Button(self.root,text="Thoát",bg="blue",command=self.exit,font=("times new roman",15)).place(x=300,y=540,width=130,height=50)
